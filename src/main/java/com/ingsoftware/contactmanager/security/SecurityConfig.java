...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/users/current").hasAnyAuthority(UserRole.ADMIN.name(),UserRole.USER.name(),"NONE")
                ...
                .antMatchers("/contacts/**").hasAnyAuthority(UserRole.ADMIN.name(),UserRole.USER.name())
