...
public class ContactController {
    ...
    public ResponseEntity<?> getAllUserContacts(@PathVariable("userGuid") UUID userGuid) throws InstanceNotFoundException {
    ...
    public ResponseEntity <?> createContact(@PathVariable("userGuid")UUID userGuid, @RequestBody ContactRequestDto contactRequestDto) throws InstanceNotFoundException {
    ...
    public ResponseEntity <?> deleteContact(@PathVariable("userGuid")UUID userGuid, @PathVariable ("contactGuid")UUID contactGuid) throws InstanceNotFoundException {
    ...
    public ResponseEntity <?> editContact(@PathVariable("userGuid")UUID userGuid,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(contactService.editContact(userGuid,contactGuid,contactRequestDto));
    }
